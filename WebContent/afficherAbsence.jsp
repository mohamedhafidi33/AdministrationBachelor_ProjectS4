				...
				<div class="page-title">
					...
					<div class="title_right">
						<div class="col-md-5 col-sm-5   form-group pull-right top_search">
							<form method="post" action="getAbsenceData">
						...
						<div class="x_panel">
							...
							<div class="x_content">
								...
								<table class="table table-striped projects">
									...
									<tbody>
										<form method="post" action="modifierAbsence">
											<c:forEach items="${absence }" var="absence">
												...
												<tr>
													...
													<td><a> ${absence.getEtudiant_Id() } <input
															type="hidden" name="typesalle"
															value=${absence.getEtudiant_Id() } />
													</a></td>
													<td><a> ${absence.getMatiere_Id() } <input
															type="hidden" name="typesalle"
															value=${absence.getMatiere_Id() } />
													</a></td>
													<td>
																					...
																					<div class="col-sm-12">
																						<div class="card-box">
																							...
																							<div class="card-body bulk_action">
																								<h5 class="card-title">Modification d'absence</h5>
																								<div class="form-row">
																									<div class="col-md-6">
																										<div class="position-relative form-group">
																											<label for="last_name_fr" class="">Id
																											</label><input
																												value='<c:out value="${absence.id }"></c:out>'
																								...
																								<div class="field item form-group">
																									<label
																										class="col-form-label col-md-3 col-sm-3  label-align">Argument<span
																										class="required"></span>
																									</label>
																									<div class="btn-group">
																										<input type="file" data-role="magic-overlay"
																											name="argument" data-target="#pictureBtn"
														...
														<button class="btn btn-danger btn-xs" formmethod="POST"
															formaction="deleteAbsence">Suprimer</button>
															<a type="button" class="btn btn-secondary" href="sendEmail.jsp">Envoyer email</a>
<!-- 														<button type="button" href="SendEmail" class="btn btn-secondary">Envoyer email</button> -->

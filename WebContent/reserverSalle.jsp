                        ...
                        <form method="post" action="reserver" > 
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <input type="hidden"  name="creneau" value="C1" />
                  <button type="submit" class="btn btn-primary btn-xs" data-toggle="modal" data-target=".bs-example-modal-lg" >Réserver </button>
					  </td>
                <td>
                <input type="hidden"  name="creneau" value="C2" />
                  <button type="submit" class="btn btn-primary btn-xs" data-toggle="modal" data-target=".bs-example-modal-lg" >Réserver </button>
                  </td>
                 <td>
                 <input type="hidden"  name="creneau" value="C3" />
                  <button type="submit" class="btn btn-primary btn-xs" data-toggle="modal" data-target=".bs-example-modal-lg" >Réserver </button>
                  </td>
                  <td>
                  <input type="hidden"  name="creneau" value="C4" />
                  <button type="submit" class="btn btn-primary btn-xs" data-toggle="modal" data-target=".bs-example-modal-lg" >Réserver </button>
                  </td>

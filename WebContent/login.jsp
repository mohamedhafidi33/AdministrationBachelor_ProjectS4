			...
			<div class="animate form login_form">
				<section class="login_content">
					<form method="post" action="login">
						...
						<div>
							<!-- <a type="submit" class="btn btn-default submit" href="index.html">Log in</a>-->
							<input type="submit" class="btn btn-default submit"
								value="log in"> <a class="reset_pass" href="#">Lost
								your password?</a>
						</div>
						...
						<div class="separator">
							...
							<div>
								<h1>
									<i class="fa fa-paw"></i> Administration Bachelor!
								</h1>
